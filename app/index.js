...
function init() {
	...
	//设置3D空间的6个面
	var sides = [{
		url: './resources/img/posx.jpg',
		position: [-512, 0, 0],
		rotation: [0, Math.PI / 2, 0]
	}, {
		url: './resources/img/negx.jpg',
		position: [512, 0, 0],
		rotation: [0, -Math.PI / 2, 0]
	}, {
		url: './resources/img/posy.jpg',
		position: [0, 512, 0],
		rotation: [Math.PI / 2, 0, Math.PI]
	}, {
		url: './resources/img/negy.jpg',
		position: [0, -512, 0],
		rotation: [-Math.PI / 2, 0, Math.PI]
	}, {
		url: './resources/img/posz.jpg',
		position: [0, 0, 512],
		rotation: [0, Math.PI, 0]
	}, {
		url: './resources/img/negz.jpg',
		position: [0, 0, -512],
		rotation: [0, 0, 0]
	}];
	//生成dom元素
